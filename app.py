...
with tab1:
    ...
    st.dataframe(df_disp.head(500), use_container_width=True, hide_index=True, height=280)
...
with tab2:
    ...
    st.dataframe(rec_disp.head(500), use_container_width=True, hide_index=True, height=280)
